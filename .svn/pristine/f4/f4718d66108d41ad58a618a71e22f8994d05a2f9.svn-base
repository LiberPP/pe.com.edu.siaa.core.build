...
public class BigMemoryManager<K, V> implements Serializable {
	...
	private List<String> listaKey = new ArrayList<String>();
	private List<String> listaKeyHelp = new ArrayList<String>();
