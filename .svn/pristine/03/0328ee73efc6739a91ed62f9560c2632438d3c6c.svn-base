...
public class DetalleProformaDTO extends BasePaginator implements Serializable {
     ...
     */
    public DetalleProformaDTO(String idDetalleProforma, ProformaDTO proforma,ProductoDTO producto,String descripcionProducto, BigDecimal precio, BigDecimal cantidad, BigDecimal descuento, BigDecimal subMontoTotal, BigDecimal montoTotal ) {
        super();
