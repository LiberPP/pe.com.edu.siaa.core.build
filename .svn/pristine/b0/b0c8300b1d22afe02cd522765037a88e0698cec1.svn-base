...
public enum TipoComponenteType {
	...
	/** La Constante looKup. */
	private static final Map<Long, TipoComponenteType> LOO_KUP_MAP = new HashMap<Long, TipoComponenteType>();
	
	static {
		for (TipoComponenteType s : EnumSet.allOf(TipoComponenteType.class)) {
