 ...
 * @since SIAA-CORE 2.1
 */
public class GenericReporteDAOImpl<K,T> extends GenericOperacionDAOImpl {

	private Logger log = Logger.getLogger(GenericReporteDAOImpl.class);

	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.REPORTE_MODEL)
	private EntityManager entityManager;

	public GenericReporteDAOImpl () {
