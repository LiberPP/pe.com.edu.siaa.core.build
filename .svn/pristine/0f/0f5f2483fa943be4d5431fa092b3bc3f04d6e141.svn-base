 ...
 * @since SIAA-CORE 2.1
 */
public class GenericContabilidadDAOImpl<K,T> extends GenericOperacionDAOImpl {

	private Logger log = Logger.getLogger(GenericContabilidadDAOImpl.class);

	/** El objeto entity manager. */
	@PersistenceContext(unitName = ConfiguracionEntityManagerUtil.CORE_MODEL)
	private EntityManager entityManager;

	public GenericContabilidadDAOImpl () {
