...
public enum FlagConceptoPagoFraccionadoType {
	...
	private static final Map<String, FlagConceptoPagoFraccionadoType> LOO_KUP_MAP = new HashMap<String, FlagConceptoPagoFraccionadoType>();
	
	
	static {
		for (FlagConceptoPagoFraccionadoType s : EnumSet.allOf(FlagConceptoPagoFraccionadoType.class)) {
