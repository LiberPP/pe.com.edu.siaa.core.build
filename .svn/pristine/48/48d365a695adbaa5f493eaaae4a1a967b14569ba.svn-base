...
public enum  TipoReporteGenerarType {
	...
	TXT("txt","tipoReporteGenerar.txt","text/text",false);
	
	/** La Constante LOO_KUP_MAP. */
	private static final Map<String, TipoReporteGenerarType> LOO_KUP_MAP = new HashMap<String, TipoReporteGenerarType>();
