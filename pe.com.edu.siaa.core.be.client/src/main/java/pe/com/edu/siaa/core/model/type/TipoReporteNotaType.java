...
public enum TipoReporteNotaType {
	...
	private static final Map<String, TipoReporteNotaType> LOO_KUP_MAP = new HashMap<String, TipoReporteNotaType>();
	
	
	static {
		for (TipoReporteNotaType s : EnumSet.allOf(TipoReporteNotaType.class)) {
