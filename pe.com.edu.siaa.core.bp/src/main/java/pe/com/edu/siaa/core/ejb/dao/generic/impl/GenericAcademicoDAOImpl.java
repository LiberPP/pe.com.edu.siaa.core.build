 ...
 * @since SIAA-CORE 2.1
 */
public class GenericAcademicoDAOImpl<K,T> extends GenericOperacionDAOImpl {

	private Logger log = Logger.getLogger(GenericAcademicoDAOImpl.class);
	...
	public GenericAcademicoDAOImpl () {
